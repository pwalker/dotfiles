...
- **topic/brew.sh**: Any file named `brew.sh` is executed after homebrew is installed, but during the `script/install`.  See `zsh/packages/` for an example
...
```sh
git clone https://github.com/pwalker/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
